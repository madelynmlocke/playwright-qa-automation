# Bug Report: PUT /brandsList returns HTTP 200 instead of expected 405
---

## Summary
Sending a POST request to /api/brandsList is returning an incorrect HTTP response of 200 instead of 405. 
